...
- **Product surfaces:** Home shell, Codex (SRD spells, species/classes, monsters/animals with preset filters, items), Characters (create/view/inline-edit/level-up slices), Smithy MVP (homebrew items + declarative spells), Realms (Grid/List/Graph + relationship panels), Campaigns browser + live play.
