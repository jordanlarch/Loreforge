  ...
  dungeon: [
    ...
    // —— Rooms —— (the Dungeon's signature tab: each room is a structured entry)
    {
      ...
      fields: [
        ...
        { key: "description", label: "Description", kind: "textarea" },
        { key: "floorIndex", label: "Floor", kind: "number", min: 0, max: 99 },
    ...
    {
      key: "wanderingMonsterEntries",
      label: "Wandering Monsters",
      kind: "group",
      section: "Monsters",
      itemLabel: "Patrol",
      fields: [
        { key: "label", label: "Label", kind: "text", placeholder: "Skeleton patrol in the east wing" },
        { key: "codexSlug", label: "Codex creature slug", kind: "text", placeholder: "Set via Search Codex" },
    ...
    {
      key: "explorationHazards",
      label: "Exploration Hazards",
      kind: "list",
      section: "Exploration Hazards",
      itemLabel: "Hazard",
      placeholder: "Burning, Dehydration, Falling, Malnutrition, Suffocation…",
    },
    // —— Secrets & Hooks ——
