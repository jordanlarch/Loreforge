...
**Dungeon exploration (locked Jun–Jul 2026):** `docs/engine/dungeon-exploration.md` — one scene per floor, zone + connection model, detection triggers, implementation phasing DUN-1–8 (**DUN-1–8 shipped**). Supersedes PR #356 per-room scene design.
