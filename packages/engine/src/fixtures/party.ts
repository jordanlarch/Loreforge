...
export const FIXTURE_CHARACTERS: FixtureCharacter[] = [
  {
    ...
    species: "Dwarf",
    background: "Soldier",
    classes: [{ class: "Fighter", level: 9, subclass: "Champion" }],
  ...
  {
    id: "pc:galen",
    name: "Fenris Stormcaller",
    species: "Human",
    background: "Hermit",
    classes: [{ class: "Druid", level: 5, subclass: "Circle of the Land" }],
    abilityScores: { str: 10, dex: 14, con: 14, int: 10, wis: 18, cha: 12 },
    maxHp: 36,
    baseAc: 14,
    speed: 30,
    saveProficiencies: ["int", "wis"],
    skillProficiencies: ["Nature", "Survival", "Perception"],
  ...
  },
  {
    ...
    species: "Human",
    background: "Acolyte",
    classes: [{ class: "Cleric", level: 5, subclass: "Life Domain" }],
    abilityScores: { str: 14, dex: 10, con: 14, int: 10, wis: 16, cha: 12 },
    maxHp: 36,
    baseAc: 16,
    speed: 30,
    saveProficiencies: ["wis", "cha"],
    skillProficiencies: ["Medicine", "Religion", "Insight"],
    weaponProficiencies: ["Simple Weapons"],
  },
];
