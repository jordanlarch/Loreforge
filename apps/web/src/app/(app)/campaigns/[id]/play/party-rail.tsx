        ...
        <div className="flex items-center justify-between gap-2">
          ...
          {active && (
            <span
              ...
              className="shrink-0 text-[10px] font-semibold uppercase tracking-wide text-lore-accent"
            >
              ▶
            </span>
          )}
...
function MiniHud({ member }: { member: EntityState }) {
  ...
  return (
    <div className="pointer-events-none absolute left-full top-0 z-20 ml-2 hidden w-60 rounded-lg border border-lore-border bg-lore-surface p-3 shadow-lg group-hover/chip:block">
