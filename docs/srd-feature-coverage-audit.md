...
| Subclasses (12) | catalog ✅ | **12 of 12 wired** (all SRD subclasses have at least one mechanical tracer) | 🟢 | SRD-FID-21b |
...
| SRD-FID-21 | Class & subclass features | text + resource counters | **Partial** — Sneak Attack, Rage, Bardic Inspiration (PR #334); Monk Focus, Stunning Strike, Metamagic, Agonizing Blast (PR #335); product wiring (PR #336); Paladin Lay on Hands / Channel Divinity / Divine Smite (PR #337); Metamagic expansion + Eldritch Invocation expansion (PR #338); subclass tracers in SRD-FID-21b (PR #339–#340); remaining class + subclass features still display-only. |
